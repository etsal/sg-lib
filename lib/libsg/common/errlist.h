...
typedef enum _ret_t {
  ...
  ER_RA_VERIFY = MK_ERROR(0x5109),
  ER_CLIENT_AUTH = MK_ERROR(0x5110),

  ER_ACCEPT_CLIENT = MK_ERROR(0x5200),
  ER_CONNECT_SERVER = MK_ERROR(0x5201),
  ER_WOLFSSL_NEW = MK_ERROR(0x5202),
  ER_WOLFSSL_NEGOTIATE = MK_ERROR(0x5203),
  ER_WOLFSSL_OTHER =MK_ERROR(0x5204)
