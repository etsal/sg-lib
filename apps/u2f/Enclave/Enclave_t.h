...
void ecall_generate_site_keys(unsigned char* key_handle, size_t key_handle_len, unsigned char* public_key, size_t public_key_len);
int ecall_generate_registration_signature(const unsigned char* key_handle, size_t key_handle_len, const unsigned char* data, size_t data_len, unsigned char* signature, size_t signature_len);
int ecall_generate_authentication_signature(const unsigned char* key_handle, size_t key_handle_len, const unsigned char* data, size_t data_len, unsigned char* signature, size_t signature_len);
uint32_t ecall_inc_and_get_site_counter(const unsigned char* key_handle, size_t key_handle_len);
